...
bool CombatSystem::checkVictory(Character& player, Character& enemy)
{
    ...
    if (player.getHealth() <= 0)
    {
        ...
        cout << "\nСмерть... горькая тишина опустилась на битву. Тело героя лежит бездыханное, но что-то внутри него еще борется..." << endl;
        this_thread::sleep_for(chrono::milliseconds(1000));
        cout << "Слабый пульс начинает пульсировать вновь. Глаза героя открываются, словно он получил новую жизнь." << endl;
        this_thread::sleep_for(chrono::milliseconds(1000));
        cout << "Герой, смутно помня предыдущие события, чувствует, что его сила возросла. Он стал сильнее, быстрее, живучее..." << endl;
        this_thread::sleep_for(chrono::milliseconds(1000));
