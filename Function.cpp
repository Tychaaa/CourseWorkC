...
void chapter_two(Character& character)
{
    ...
    vector<string> chapterTwoArt = {
        ...
        " | | | |/ _ \\  / _` | / _ \\ | | | | \\___ \\ / _ \\| '_ \\ ",
        " | |_| |  __/ | (_| || (_) || |_| |  ___) | (_) | |_) |",
        " |____/ \\___|  \\__,_| \\___/  \\__,_| |____/ \\___/|_.__/ "
    };
    ...
    Screen::displayText("Путь был труден, но герой несмотря на все трудности продолжал идти, стремясь к новым приключениям.");
    this_thread::sleep_for(chrono::milliseconds(1500));
    ...
    vector<string> elfPhrases = {
        "\"- Добро пожаловать в лесную долину, " + character.getName() + ". Здесь вы почувствуете силу природы и встретите ее хранителей.\"",
        "\"- Лес - место таинственное и магическое. Я рад видеть тебя здесь, искатель приключений.\"",
        "\"- Если у тебя есть вопросы о лесе или природе, не стесняйся спрашивать. Я с удовольствием поделюсь своими знаниями.\"",
    ...
    NPC elf(
        "Эльриан",
        "Древний эльф, живущий в лесной долине. Эльриан - страж леса и его древних тайн.\n"
        "Он может помочь герою понять природу леса и его особенности.",
        elfPhrases
    );
    ...
    /*
    * TODO: придумать с кем будет бой после выхода из локации
    */

    CombatSystem fight;

    //fight.startGame(character, darkShadow);
}
