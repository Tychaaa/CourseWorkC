...
void finalFight(Character& character)
{
    ...
    DarkLord darklord("Владыка Тьмы Вергилий", 600, 500, 400);
    Demon demon("Демон-стражник Азгар", 550, 450, 450);
    Succubus succubus("Суккуб Малина", 500, 400, 500);
    Witch witch("Ведьма Лилит", 550, 500, 450);
    Enchantress enchantress("Зачаровательница Моргана", 500, 450, 500);
    DarkElf darkElf("Темная эльфийка Аделлия", 520, 480, 480);

    Screen::displayDialog("Рассказчик", "Главный герой подходит к темным вратам, за которыми состоится последний бой.");
    Screen::displayDialog("Рассказчик", "Перед вами возвышается Демон-стражник Азгар, готовый испытать ваши силы.");
    Screen::displayDialog("Демон-стражник Азгар", "Так, ты добрался сюда, смертный. Но это будет твой последний шаг!");
    Screen::displayDialog(character.getName(), "Я не остановлюсь, пока не сокрушу твои темные планы!");
    Screen::displayDialog("Демон - стражник Азгар", "Увидим, увидим... Начнем наше последнее противостояние!");

    // Бой с Демон - стражник Азгар
    Screen::displayDialog("Рассказчик", "И вот, первым выходит на бой Демон - стражник Азгар!\n");
